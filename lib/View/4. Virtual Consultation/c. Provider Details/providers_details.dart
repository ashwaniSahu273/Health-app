                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(top:20.0, left: 10,bottom: 15),
                              child: Text('Select Consultation Duration', style: TextStyle(fontWeight: FontWeight.bold)),
                            ),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceAround,
                              children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      Text('Experience: ${widget.providerData['experience'] ?? 'N/A'}'),
                    ],
                  ),
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 4),
                        Text('Telemedicine: 30 min',style: TextStyle(color: Colors.grey),),
                      ],
                    ),
                  ),
                ],
