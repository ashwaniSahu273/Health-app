...
class AddOrEditServiceForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (isEditing && service != null) {
      ...
      _arInstructionsController.text = service!.localized.ar.instructions ?? '';
      _enInstructionsController.text = service!.localized.en.instructions ?? '';
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (isEditing) {
                      FirebaseFirestore.instance
                          ...
                          .doc(
                              service.id.toString()) // Replace with the actual serviceId you want to update
                          .update(newService);
                    } else {
                      // FirebaseFirestore.instance
                      //     .collection('LaboratoryServices')
